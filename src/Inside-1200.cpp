...
Update Log:
    1. 加入AI功能（测试中，按ESC呼出游戏菜单，按3(不能是小键盘上的)，这样玩家B就会成为AI操控(反应太快了，我都打不赢，以后会优化)）
...
void draw(){
    ...
    if (stop) {
        ...
        setConsolePos(47,20);
        printf("4 : Open/Close AI for player1(Testing)");
    }
}
...
void init(){
    over=false;
    stop=false;
    SetConsoleTitle("Friend War Inside-1200");
    SetConsoleTextAttribute(STDOUT_HANDLE,0x07);
    printf(" ----------------------------------\n");Sleep(11);
    printf(" |                                |\n");Sleep(10);
    printf(" |                                |\n");Sleep(10);
    ...
    printf(" |                                |\n");Sleep(10);
    printf(" ----------------------------------\n");Sleep(11);
    printf(" Version Inside-1200    Made in Tianxun\n\n\n");Sleep(10);
    printf(" Loading: ");
    SetConsoleTextAttribute(STDOUT_HANDLE,0x88);
    printf("                                                  \n");Sleep(10);
    SetConsoleTextAttribute(STDOUT_HANDLE,0x07);
